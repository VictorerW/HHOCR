#
#  Be sure to run `pod spec lint HHOCR.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/VictorerW"
  ...
  s.source       = { :git => "https://github.com/VictorerW/HHOCR.git", :tag => "#{s.version}" }
  ...
  # s.framework  = "SomeFramework"
   s.weak_frameworks = "AssetsLibrary","AVFoundation"
